...
void Escena::dibujar()
{
   ...
   switch (seleccionDibujo){
      case 1:
         ...
         tetraedro->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix();
         break;
      ...
      case 2:
         ...
         glScalef(25,25,25);
         cubo->setColor(0,1,0);
         cubo->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix();
         break;
      ...
      case 3:
         ...
         peon->setColor(1,0,0);
         peon->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix();
         break;
      ...
      case 4:
         ...
         hormiga->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix();
         break;
      ...
      case 5:
         ...
         cilindro->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix();
         break;
      ...
      case 6:
         ...
         glScalef(3,3,3);
         cono->setColor(0,1,0);
         cono->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix();
         break;    
      ...
      case 7:
         ...
         esfera->draw(metodoDibujado,ajedrez,tapas);
         glPopMatrix(); 
         break;
